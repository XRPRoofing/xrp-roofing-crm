                ...
                <div className="space-y-2 p-2">
                  ...
                  {colTasks.map((task) => (
                    <button
                      ...
                      className={`group w-full rounded-xl border bg-white p-3 text-left shadow-sm active:scale-[0.98] ${c.border}`}
                    >
                      <div className="flex items-start justify-between gap-2">
                        ...
                        <div className="flex shrink-0 items-center gap-1">
                          <button type="button" onClick={(e) => { e.stopPropagation(); deleteTask(task); }} className="hidden rounded-lg p-1 text-slate-300 transition hover:bg-orange-50 hover:text-orange-500 group-hover:flex" aria-label="Delete task"><Trash2 className="h-3.5 w-3.5" /></button>
              ...
              <div className="flex min-h-[80px] flex-1 flex-col gap-1.5 overflow-y-auto p-1.5">
                {colTasks.map((task) => (
                  <article
                    ...
                    onClick={() => setSelectedTask(task)}
                    className={`group cursor-pointer rounded-xl border bg-white p-2.5 shadow-sm transition hover:shadow-md hover:-translate-y-0.5 ${draggedId === task.id ? "opacity-40" : ""} ${c.border}`}
                  >
                    <div className="flex items-start justify-between gap-1">
                      ...
                      <button type="button" onClick={(e) => { e.stopPropagation(); deleteTask(task); }} className="hidden shrink-0 rounded-lg p-0.5 text-slate-300 transition hover:bg-orange-50 hover:text-orange-500 group-hover:flex" aria-label="Delete task"><Trash2 className="h-3 w-3" /></button>
                    </div>
        ...
        <div className="fixed inset-0 z-50 flex items-end justify-center sm:items-center" onClick={() => setSelectedTask(null)}>
          ...
          <div className="relative z-10 w-full max-w-lg max-h-[90vh] overflow-y-auto rounded-t-3xl bg-white p-5 shadow-2xl sm:rounded-3xl" onClick={(e) => e.stopPropagation()}>
            <div className="flex items-start justify-between gap-3">
              ...
              <div className="flex shrink-0 items-center gap-1">
                <button type="button" onClick={() => deleteTask(selectedTask)} className="inline-flex items-center gap-1.5 rounded-xl border border-orange-200 bg-orange-50 px-3 py-2 text-xs font-black text-orange-700 transition hover:bg-orange-100"><Trash2 className="h-4 w-4" />Delete</button>
            ...
            {/* Delete task */}
            <button type="button" onClick={() => deleteTask(selectedTask)} className="mt-3 w-full rounded-2xl border border-orange-200 bg-orange-50 py-2.5 text-sm font-black text-orange-700 transition hover:bg-orange-100 flex items-center justify-center gap-2">
