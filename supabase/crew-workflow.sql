...
values
  ...
  ('L-1002', 'Desert Plaza HOA', 'board@example.com', '(480) 555-0134', '8800 N Scottsdale Rd', 'Scottsdale', 'inspection_scheduled', 72000, 'Johnny Roofer', 'Flat/TPO', 'Referral', 'Inspection booked for Friday', 'Complete inspection', '2026-06-03', 'Assigned', '["Darwin"]'::jsonb, '2026-06-05', 'Flat/TPO', 'Inspection booked for Friday'),
  ...
  ('L-1004', 'Sage Medical Center', 'facilities@example.com', '(602) 555-0112', '1201 W Thomas Rd', 'Phoenix', 'waiting_approval', 98000, 'Admin User', 'Commercial Flat', 'Partner', 'Carrier document review', 'Get approval decision', '2026-05-30', 'Assigned', '["Darwin"]'::jsonb, '2026-06-05', 'Commercial Flat', 'Carrier document review'),
  ...
  ('L-1006', 'Carlos Vega', 'carlos@example.com', '(602) 555-0148', '4119 N 15th Ave', 'Phoenix', 'in_progress', 14200, 'Office Coordinator', 'Repair', 'Website', 'Crew dispatched', 'Confirm crew progress', '2026-05-31', 'In Progress', '["Darwin"]'::jsonb, '2026-06-05', 'Repair', 'Crew dispatched'),
